...
const Explorer = () => {
  const destinations = [
    {
      id: 1,
      image: Explorer1,
      title: "The Secret Villages of Andalusia.",
    ...
    },
    {
      id: 2,
      image: Explorer2,
      title: "Tuscany Through the Seasons.",
    ...
    },
    {
      id: 3,
      image: Explorer3,
      title: "Private Access in Seville.",
    ...
    },
    {
      id: 4,
      image: Explorer4,
      title: "Cultural Immersion in Lisbon.",
      description:
    ...
    },
    {
      id: 5,
      image: Explorer5,
      title: "Bordeaux for the Curious Palate.",
    ...
    },
    {
      id: 6,
      image: Explorer6,
      title: "Hidden Switzerland by Rail.",
  ...
  return (
    <div>
      ...
      <section className="relative flex flex-col lg:flex-row items-center justify-between text-center bg-[#F2F2F2] my-6 sm:my-12 lg:my-20 py-8 sm:py-12 lg:py-36 px-4 sm:px-6 lg:mr-20 max-w-full sm:max-w-4xl lg:max-w-5xl mx-auto">
        ...
        <div className="lg:w-1/2 h-full flex flex-col justify-center px-4 sm:px-6 lg:pr-20 lg:pl-4 lg:ml-[30rem] font-berlingske mt-6 lg:mt-0">
          ...
          <p className="mt-4 sm:mt-5 text-sm sm:text-[16px] text-[#0A0024] leading-relaxed max-w-md mx-auto">
            Thoughtfully Designed Experiences Tailored for Your Clients.
          </p>

          <p className="mt-4 sm:mt-5 text-sm sm:text-[16px] text-[#0A0024] leading-relaxed max-w-md mx-auto">
            Partner with Aquila to offer unparalleled personalized travel
            experiences, seamlessly tailored to your client's unique desires and
            standards.
          </p>
