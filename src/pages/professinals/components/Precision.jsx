  ...
  return (
    <div className="flex flex-col gap-6 items-center text-center    py-14 ">
      <div className="flex flex-col items-center justify-center gap-4">
        <h1 className="text-[12px]  text-[#0A0024] leading-[19px] font-neutra  tracking-[1.56px] uppercase ">
      ...
      <p className="text-[20px] text-[#0A0024] leading-[24px]  font-berlingske  tracking-[0.5px] w-full sm:w-[70%] md:w-[40%]">
        Aquila specializes in crafting memorable experiences for Destination
        Weddings, Accessible Luxury Travel, and European Relocation &
        Investment, catering thoughtfully to your clients' specialized
        requirements.
      </p>
