...
const Pricing = () => {
  return (
    ...
    <h1 className='text-[12px]  text-[#0A0024] leading-[19px] font-neutra  tracking-[1.56px] '>TAILORED EXPERIENCE</h1>
       ...
       <p className='text-[20px] text-[#0A0024] leading-[28px]  font-berlingske  tracking-[0.2px]  w-[40%]'>
       At Aquila, we value transparency and flexibility. Our clear pricing structures and rewarding commissions empower you to confidently offer exceptional luxury travel assistance, ensuring mutually beneficial outcomes for your business and your clients.
       </p>

       <div className={`flex  gap-10 mt-8 `}>
             {listItems.map((item, index) => (
               <IconListItem key={index} icon={item.icon} text={item.text} direction='column' />
             ))}
           </div>
